...
<template>
  <section class="mx-auto max-w-6xl px-4 py-6">
    ...
    >
      <RouterLink to="/" class="text-sm font-medium text-slate-900 underline"
        >Ke halaman Products</RouterLink
      >
    </EmptyState>

    <div
      v-else
      class="mt-6 grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4"
    >
      <ProductCard
